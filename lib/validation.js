...
function isRSAA(action) {
  ...
  console.log('isPlainObject ' + _lodashIsplainobject2['default'](action));
  console.log('hasOwnProperty ' + action.hasOwnProperty(_CALL_API2['default']));
  console.log('CALL_API ' + _CALL_API2['default']);
...
function validateRSAA(action) {
  ...
  for (var key in action) {
    console.log('key: ' + key + 'CALL_API arr : ' + [_CALL_API2['default']]);
    console.log('with arr ' + key !== [_CALL_API2['default']]);
    console.log('without arr ' + key !== _CALL_API2['default']);
